...
`);
  ...
  await addColumn(`ALTER TABLE assignments ADD COLUMN show_student_evidence INTEGER NOT NULL DEFAULT 0`);
  await addColumn(`ALTER TABLE assignments ADD COLUMN show_student_composition INTEGER NOT NULL DEFAULT 0`);
  await addColumn(`ALTER TABLE assignments ADD COLUMN student_scaffold TEXT DEFAULT ''`);
  await addColumn(`ALTER TABLE assignments ADD COLUMN rubric_text TEXT DEFAULT ''`);
  await addColumn(`ALTER TABLE assignments ADD COLUMN class_id INTEGER`);
